...
load('../../../Data/Results/Simulation/p-300-d-10-T-100-data-regA-smoothsparseC.mat');
...
save(['../../../Data/Results/Simulation/p-',num2str(p),'-d-',num2str(d),'-T-',num2str(T),'-sim2-result.mat'],'p','d','T','penaltyA','penaltyC','cormat','A','C','aa','cc','paa','pcc');
