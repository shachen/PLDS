...
However, the above solutions can not be directly applied to optimization problem \ref{eqn:penaltylik} due to the introduced penalty terms. A new algorithm is then developed and detailed as follows.
...
%\begin{aligned}
\hat{\mathbf{x}}_t \equiv E[\mathbf{x_t}|\{\mathbf{y}\}],\  P_t  \equiv E[\mathbf{x}_t\mathbf{x}_t^{\prime}|\{\mathbf{y}\}],\  P_{t,t-1}  \equiv E[\mathbf{x}_t\mathbf{x}_{t-1}^{\prime}|\{\mathbf{y}\}].
%\end{aligned}
\end{equation}
