...
\begin{aligned}
P(\mathbf{y}_t|\mathbf{x}_t)&=\text{exp}\left\{-\frac{1}{2}[\mathbf{y}_t-C\mathbf{x}_t]^{\T}R^{-1}[\mathbf{y}_t-C\mathbf{x}_t]\right\} (2\pi)^{-p/2}|R|^{-1/2}\\
...
&=\text{exp}\left\{-\frac{1}{2}[\mathbf{x}_t-A\mathbf{x}_{t-1}]^{\T}[\mathbf{x}_t-A\mathbf{x}_{t-1}]\right\}(2\pi)^{-d/2}.
\end{aligned}
\end{equation*}
